...
<%
    ...
    application.setAttribute("id", sessionId);
    String applicationValue = (String) application.getAttribute("id");
    if (applicationValue!=null) {
        if (!sessionId.equals(applicationValue)) {
...
<head>
    ...
    <title>XHY课堂后台</title>
    <!-- Bootstrap Styles-->
    <link href="/test/assets1/css/bootstrap.css" rel="stylesheet"/>
    <!-- FontAwesome Styles-->
    <link href="/test/assets1/css/font-awesome.css" rel="stylesheet"/>
    <!-- Morris Chart Styles-->
    <link href="/test/assets1/js/morris/morris-0.4.3.min.css" rel="stylesheet"/>
    <!-- Custom Styles-->
    <link href="/test/assets1/css/custom-styles.css" rel="stylesheet"/>
    <!-- Google Fonts-->
...
<div id="wrapper">
    <nav class="navbar navbar-default top-navbar" role="navigation">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="jsp/index.jsp"><i class="fa fa-gear"></i> <strong>XHYclass</strong></a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user">
                    ...
                    <li class="divider"></li>
                    <li><a href="../test/"><i class="fa fa-sign-out fa-fw"></i> 退出登录</a>
                    </li>
                </ul>
                <!-- /.dropdown-user -->
            </li>
...
<!-- JS Scripts-->
<!-- jQuery Js -->
<script src="/test/assets1/js/jquery-1.10.2.js"></script>
<!-- Bootstrap Js -->
<script src="/test/assets1/js/bootstrap.min.js"></script>

<!-- Metis Menu Js -->
<script src="/test/assets1/js/jquery.metisMenu.js"></script>
<!-- Morris Chart Js -->
<script src="/test/assets1/js/morris/raphael-2.1.0.min.js"></script>
<script src="/test/assets1/js/morris/morris.js"></script>


<script src="/test/assets1/js/easypiechart.js"></script>
<script src="/test/assets1/js/easypiechart-data.js"></script>

<script src="/test/assets1/js/Lightweight-Chart/jquery.chart.js"></script>

<!-- Custom Js -->
<script src="/test/assets1/js/custom-scripts.js"></script>

<script>
    setInterval(function () {
        var sessionId=${pageContext.session.id};
        var application=<%=application.getAttribute("id")%>;
